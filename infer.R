...
make.lineage<-function(xx, gbm.fit, thrs, n.trees){
  ...
  if(length(record)==3)	lng<-paste0("(", as.character(record[[1]]),',', as.character(record[[2]]),',', as.character(record[[3]]),")", "root;")
  
  if(length(record)==4)	lng<-paste0("(", as.character(record[[1]]),',', as.character(record[[2]]),',', as.character(record[[3]]),',', as.character(record[[4]]),")", "root;")
  
  if(length(record)==5)	lng<-paste0("(", as.character(record[[1]]),',', as.character(record[[2]]),',', as.character(record[[3]]),',', as.character(record[[4]]),',', as.character(record[[5]]),")", "root;")
  
  if(length(record)==6)	lng<-paste0("(", as.character(record[[1]]),',', as.character(record[[2]]),',', as.character(record[[3]]),',', as.character(record[[4]]),',', as.character(record[[5]]),',', as.character(record[[6]]),")", "root;")
  
  if(length(record)==7)	lng<-paste0("(", as.character(record[[1]]),',', as.character(record[[2]]),',', as.character(record[[3]]),',', as.character(record[[4]]),',', as.character(record[[5]]),',', as.character(record[[6]]),',', as.character(record[[7]]),")", "root;")
  
  if(length(record)==8)	lng<-paste0("(", as.character(record[[1]]),',', as.character(record[[2]]),',', as.character(record[[3]]),',', as.character(record[[4]]),',', as.character(record[[5]]),',', as.character(record[[6]]),',', as.character(record[[7]]),',', as.character(record[[8]]),")", "root;")
  
  if(length(record)==9)	lng<-paste0("(", as.character(record[[1]]),',', as.character(record[[2]]),',', as.character(record[[3]]),',', as.character(record[[4]]),',', as.character(record[[5]]),',', as.character(record[[6]]),',', as.character(record[[7]]),',', as.character(record[[8]]),',', as.character(record[[9]]),")", "root;")
